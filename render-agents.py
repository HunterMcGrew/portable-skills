...
def check_all(root=ROOT):
    ...
    # A note whose job is naming what is unchecked overstates in the one
    # direction that buys false confidence, so its reach is read off the
    # globs, never recalled.

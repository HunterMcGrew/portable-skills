...
Run the shared core's Opening Orientation Battery now, after startup and before any requirements work — all four questions (Intent / Ambiguity / Bounds / Approach) answered inline, then persisted to the plan's `## Sessions`.

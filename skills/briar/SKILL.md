...
Plan the passes explicitly on anything past 400 lines, sized over the range pinned in § Phase 1, and never present a partial review as complete — say which passes are done and which remain rather than let context compression cut the review short silently.

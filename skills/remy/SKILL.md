...
Run the shared core's Opening Orientation Battery now, after startup and before any content work — all four questions (Intent / Ambiguity / Bounds / Approach) answered inline. Seed Bounds from the persona notes above.
